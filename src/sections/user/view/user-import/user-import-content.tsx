...
const TEMPLATE_ROWS = [
  {
    ...
    contactMembre: '050412302',
    sexeMembre: 'M',
    civiliteMembre: 'Monsieur',
    dateNaissMembre: '09-04-2000',
    lieuNaissMembre: 'Abidjan',
    nationaliteMembre: 'Ivoirienne',
    emailMembre: 'jean@example.com',
    ethnieMembre: 'Baoule',
    residenceMembre: 'Andokoi',
    fonctionMembre: 'Etudiant',
    situationMatrimonialeMembre: 'Celibataire',
    nomFiance: '',
    dateMariageMembre: '',
    egliseOrigineMembre: 'Assemblee de Dieu',
    dateConversionMembre: '',
    nouvelleAmeMembre: 'Non',
    baptemeEauMembre: 'Oui',
    lieuBaptemeEauMembre: 'AD Sikensi',
    baptemeSaintEspritMembre: 'Non',
