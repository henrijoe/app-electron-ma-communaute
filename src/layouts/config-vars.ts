...
export const baseVars = (theme: Theme) => ({
  ...
  '--layout-nav-item-active-bg': varAlpha(theme.vars.palette.primary.mainChannel, 0.12),
  '--layout-nav-item-hover-bg': varAlpha(theme.vars.palette.primary.mainChannel, 0.2),
